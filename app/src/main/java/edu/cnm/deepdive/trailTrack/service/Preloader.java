...
public class Preloader extends RoomDatabase.Callback {
  ...
  private final Provider<PinDao> noteDaoProvider;
  private final Gson gson;

  @Inject
  Preloader(@ApplicationContext Context context, Provider<PinDao> noteDaoProvider, Gson gson) {
  ...
  public void onCreate(@NonNull SupportSQLiteDatabase db) {
    ...
    PinDao pinDao = noteDaoProvider.get();
